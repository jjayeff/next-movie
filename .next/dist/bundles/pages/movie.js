...
// CONCATENATED MODULE: ./components/movie/Trailer.js

var Trailer_Trailer = function Trailer(props) {
    return external__react__default.a.createElement(
        'div',
        { className: 'row' },
        external__react__default.a.createElement(
            'div',
            { className: 'col-lg-3' },
            external__react__default.a.createElement('img', { src: props.data.img })
        ),
        external__react__default.a.createElement(
            'div',
            { className: 'col-lg-9' },
            external__react__default.a.createElement('iframe', { src: props.data.trailer, allowFullScreen: true })
        )
    );
};

/* harmony default export */ var movie_Trailer = (Trailer_Trailer);
// CONCATENATED MODULE: ./components/movie/Synopsis.js

var Synopsis_Synopsis = function Synopsis(props) {
    return external__react__default.a.createElement(
        'div',
...
/* harmony default export */ var movie_Synopsis = (Synopsis_Synopsis);
// CONCATENATED MODULE: ./components/movie/Video.js
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Video_Video = function (_Component) {
    ...
    _createClass(Video, [{
        key: 'handleSelectPlayer',
        value: function handleSelectPlayer(data, e) {
            e.preventDefault();
            this.setState({
                player: data
            });
        ...
        value: function handleSelectSound(data, e) {
            e.preventDefault();
            this.setState({
                sound: data,
                player: 1
        ...
        key: 'renderSound',
        value: function renderSound(data) {
            if (data.videosThai && data.videosEng) {
                return external__react__default.a.createElement(
                    'div',
                    { className: 'col-xs-1 text-center pb-3' },
                    external__react__default.a.createElement(
                        'button',
                        { type: 'button', className: 'btn btn-outline-success mr-2 ' + (this.state.sound === 'thai' ? 'active' : ''), onClick: this.handleSelectSound.bind(this, 'thai') },
                        ' \u0E1E\u0E32\u0E01\u0E22\u0E4C\u0E44\u0E17\u0E22 '
                    ),
                    external__react__default.a.createElement(
                        'button',
                        { type: 'button', className: 'btn btn-outline-success mr-2 ' + (this.state.sound === 'eng' ? 'active' : ''), onClick: this.handleSelectSound.bind(this, 'eng') },
                        ' Soundtrack \u0E0B\u0E31\u0E1A\u0E44\u0E17\u0E22 '
                    )
                );
        ...
        key: 'renderPlayer',
        value: function renderPlayer(datas) {
            var _this2 = this;

            if (this.state.sound === 'eng') {
                if (typeof datas.videosEng != 'string') {
                    return datas.videosEng.map(function (data, index) {
                        return external__react__default.a.createElement(
                            'button',
                            { type: 'button', className: 'btn btn-outline-success mr-2 ' + (_this2.state.player === index + 1 ? 'active' : ''), onClick: _this2.handleSelectPlayer.bind(_this2, index + 1), key: index },
                            ' Player ',
                            index + 1,
                            ' '
                        );
                    ...
                    return external__react__default.a.createElement(
                        'button',
                        { type: 'button', className: 'btn btn-outline-success mr-2 active', onClick: this.handleSelectPlayer.bind(this, 1) },
                        ' Player 1 '
                    );
                }
            } else if (this.state.sound === 'thai') {
                if (typeof datas.videosThai != 'string') {
                    return datas.videosThai.map(function (data, index) {
                        return external__react__default.a.createElement(
                            'button',
                            { type: 'button', className: 'btn btn-outline-success mr-2 ' + (_this2.state.player === index + 1 ? 'active' : ''), onClick: _this2.handleSelectPlayer.bind(_this2, index + 1), key: index },
                            ' Player ',
        ...
        key: 'renderVideoPlaying',
        value: function renderVideoPlaying(data) {
            var path = '';
            ...
            return external__react__default.a.createElement(
                ...
                external__react__default.a.createElement('img', { src: path, width: '400' })
            );
        }
    }, {
        key: 'render',
        value: function render() {
            return external__react__default.a.createElement(
                ...
                external__react__default.a.createElement(
                    ...
                    external__react__default.a.createElement(
                        'p',
                        { className: 'text-center bold pt-2' },
                        external__react__default.a.createElement(
                            'a',
                            { className: 'mr-2', href: '#' },
                            '\u0E14\u0E39\u0E2B\u0E19\u0E31\u0E07\u0E2D\u0E2D\u0E19\u0E44\u0E25\u0E19\u0E4C'
                    ...
                    external__react__default.a.createElement(
                        'div',
                        { className: 'col-xs-1 text-center pt-3 pb-3' },
...
/* harmony default export */ var movie_Video = (Video_Video);
// CONCATENATED MODULE: ./components/movie/Left.js





var Left_Left = function Left(props) {
    return external__react__default.a.createElement(
        'div',
            ...
            external__react__default.a.createElement(
                ...
                external__react__default.a.createElement(
                    ...
                    external__react__default.a.createElement(
                        ...
                        external__react__default.a.createElement(movie_Trailer, { data: props.data }),
                        external__react__default.a.createElement(movie_Synopsis, { data: props.data }),
                        external__react__default.a.createElement(movie_Video, { data: props.data })
                    )
                )
            )
        )
...
/* harmony default export */ var movie_Left = (Left_Left);
...
// CONCATENATED MODULE: ./components/movie/Right.js




var Right_Right = function Right() {
    return external__react__default.a.createElement(
        'div',
        { className: 'col-lg-3 col-md-4 col-sm-6' },
        external__react__default.a.createElement(Group["a" /* default */], null),
        external__react__default.a.createElement(Type["a" /* default */], null)
    );
};

/* harmony default export */ var movie_Right = (Right_Right);
// CONCATENATED MODULE: ./components/movie/index.js




var movie_Index = function Index(props) {
    return external__react__default.a.createElement(
        'div',
        ...
        external__react__default.a.createElement(
            'div',
            { className: 'row' },
            external__react__default.a.createElement(movie_Left, { data: props.data }),
            external__react__default.a.createElement(movie_Right, null)
        )
    );
};

/* harmony default export */ var movie = (movie_Index);
// CONCATENATED MODULE: ./pages/movie.js




var pages_movie_Index = function Index(props) {
  return external__react__default.a.createElement(
    Layout["a" /* default */],
    { title: props.url.query.name, type: 'user' },
    external__react__default.a.createElement(movie, { data: props.url.query })
  );
};

/* harmony default export */ var pages_movie = __webpack_exports__["default"] = (pages_movie_Index);
